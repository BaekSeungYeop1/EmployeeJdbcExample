...
public class InputUtil {
    ...
    public static int getIdFromEmployeeList(List<Employee> Employees) {
        ...
        do {
            ...
            if(idIsExist(usrSelectedId, Employees)){        // 존재하는 학생의 id인지?
                ...
                System.out.println("존재하지 않는 직원 id 입니다. id 번호를 선택하시오.");
            }
        } while (!idIsExist(usrSelectedId, Employees)); // do - while문의 동작구조가 : while 조건절이 false가 뜰 때까지 do 구문을 반복한다.
        return usrSelectedId;
    }
